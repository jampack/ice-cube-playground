...
function App() {
  ...
  const checkboxItems = [
    { id: 1, name: 'item1 1122 3344 5566' },
    { id: 2, name: 'item2' },
    { id: 3, name: 'item3' },
  ];
    ...
    <div className='App'>
      <div className='container-fluid'>
        <div className='row'>
          ...
          <hr style={{ margin: '10px' }} />
          <Button icon fab color='red' size='xs'>
            <span className='fas fa-heart' />
          </Button>
          <Button icon fab color='red' size='sm'>
            <span className='fas fa-heart' />
          </Button>
          <Button icon fab color='red'>
            <span className='fas fa-heart' />
          </Button>
          <Button icon fab color='red' size='lg'>
            <span className='fas fa-heart' />
          </Button>
          <Button icon fab color='red' size='xl'>
            <span className='fas fa-heart' />
          </Button>
          {/* <hr style={{margin: '10px'}}/> */}
